...
<head>
<meta charset="utf-8">
<title>हमारा JOB / <?php echo $title;?></title>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php"><img src="<?php echo web_root; ?>plugins/home-plugins/img/Logo.png" alt="logo" height="90px" style="transform: translateY(-20px);"/></a>
                </div>
      ...
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          <p>
            ...
            <i class="icon-envelope-alt"></i> hamarajob@gmail.com
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; हमारा JOB 2021 All right reserved.  
            </p>
          </div>
        </div>
        <div class="col-lg-6">
