							...
							<div class="row">
								<div class="col-md-3 col-sm-6">
									...
									<div class="team-member">
										<!-- Image -->
										<img class="img-responsive" src="plugins/home-plugins/img/Guddu-Patel.jpg" alt="">
										<!-- Name -->
										<h4>Guddu Patel</h4>
										<span class="deg">Front End Developer </span> 
									</div>
								</div>
								<div class="col-md-3 col-sm-6">
									<!-- Team Member -->
									<div class="team-member">
										<!-- Image -->
										<img class="img-responsive" src="plugins/home-plugins/img/team1.jpg" alt="">
										<!-- Name -->
										<h4>Yukta Singh </h4>
